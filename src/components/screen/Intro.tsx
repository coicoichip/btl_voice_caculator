...
class Page extends Component<any, State> {
  ...
  private onStartRecord = async () => {
    ...
    const uri = await this.audioRecorderPlayer.startRecorder(path, true);
  ...
  private onCal = async () => {
    ...
    const path = Platform.select({
      ios: 'hello.m4a',
      android: 'file:///sdcard/hello.mp3',
      // android: '/storage/emulated/0/hello.mp3'
    });
    this.upload('http://api.voice.thanhvh.com/check', {
      audioFile: {
        uri: path,
        type: 'audio/mpeg',
        name: 'hello'
